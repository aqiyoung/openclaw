...
| `realtime.providers.openai.authMode`     | Platform API-key resolution                | Set to experimental `codex-oauth` to use the Codex app-server's logged-in subscription for client-owned OpenAI WebRTC Talk.                                                                                                                                                |
