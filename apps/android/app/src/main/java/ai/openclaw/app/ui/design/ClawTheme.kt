...
// Aligned with iOS OpenClawBrand palette (Carapace family). Soft variants stay
// alpha-based so a tint composites correctly over canvas, panel, and row surfaces.
private val ClawDarkColors =
  ClawColors(
    canvas = Color(0xFF0B0C11),
    surface = Color(0xFF13151C),
    surfaceRaised = Color(0xFF1A1D25),
    surfacePressed = Color(0xFF232630),
    accent = Color(0xFFC63838),
    accentForeground = Color(0xFFFF6B66),
    accentSoft = Color(0x1AC63838),
    accentBorder = Color(0xFFB73833),
    userMessageSurface = Color(0xFFC63838).copy(alpha = 0.12f).compositeOver(Color(0xFF0B0C11)),
    border = Color(0xFF2A2D36),
    borderStrong = Color(0xFF3A3D48),
    text = Color(0xFFF4F4F5),
    textMuted = Color(0xFFA8AABF),
    textSubtle = Color(0xFF8A8DA0),
    primary = Color(0xFFE85C56),
    primaryText = Color(0xFFFFFFFF),
    secondary = Color(0xFF00C4B0),
    success = Color(0xFF30D158),
    successSoft = Color(0x2630D158),
    warning = Color(0xFF9A5700),
    warningSoft = Color(0x269A5700),
    danger = Color(0xFFFCA5A5),
    dangerSoft = Color(0x26FCA5A5),
    codeBg = Color(0xFF0B0C11),
    codeText = Color(0xFFF4F4F5),
    codeBorder = Color(0xFF2A2D36),
  )
...
private val ClawLightColors =
  ClawColors(
    ...
    surfacePressed = Color(0xFFE8EBF0),
    accent = Color(0xFFB73833),
    accentForeground = Color(0xFFB73833),
    accentSoft = Color(0x1AB73833),
    accentBorder = Color(0xFFA32C2C),
    userMessageSurface = Color(0xFFB73833).copy(alpha = 0.15f).compositeOver(Color(0xFFF6F7F9)),
    border = Color(0xFFE4E4EA),
    borderStrong = Color(0xFFCFCFD8),
    text = Color(0xFF101014),
    textMuted = Color(0xFF5A5E6E),
    textSubtle = Color(0xFF7A7E8E),
    primary = Color(0xFFCC4B45),
    primaryText = Color(0xFFFFFFFF),
    secondary = Color(0xFF00C4B0),
    success = Color(0xFF1A7E34),
    successSoft = Color(0x221A7E34),
    warning = Color(0xFF9A5700),
    warningSoft = Color(0x229A5700),
    danger = Color(0xFFDC2626),
    dangerSoft = Color(0x22DC2626),
    codeBg = Color(0xFFF6F7F9),
