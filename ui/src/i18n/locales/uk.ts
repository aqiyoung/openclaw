...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Інкогніто",
    incognitoDescription: "Зберігати цю гілку лише до перезапуску Gateway",
  ...
  modelSetup: {
    ...
    prepare: {
      title: "Налаштування локальної моделі",
      ...
      llamaCppHint:
        "Завантажте локальну модель розміром приблизно 5,0 ГБ; потрібно 16 ГБ оперативної пам’яті",
    },
    manual: {
    ...
    wizard: {
      ...
      prepareTitle: "Налаштування локальної моделі",
  ...
  profilePage: {
    ...
    identity: {
      title: "Ідентичність",
      menuLabel: "Меню ідентифікації",
      menuButtonLabel: "Меню ідентифікації та застосунку для {name}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілка перейшла на іншу розвилку — перегляньте та надішліть повторно.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
