...
export const de: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      intro: "Ein lokales Modell auf diesem Gateway herunterladen oder vorbereiten.",
      button: "Modell einrichten / herunterladen",
      ollamaLabel: "Ollama",
      ollamaHint: "Ein Tools-fähiges Modell von deinem Ollama-Server herunterladen",
      llamaCppLabel: "Lokales Modell (llama.cpp)",
      llamaCppHint: "Ein etwa 5,0 GB großes lokales Modell herunterladen; erfordert 16 GB RAM",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Dieser Browser benötigt nach dem Update noch eine einmalige Gerätebestätigung.",
      ...
      pendingUnavailable:
        "Die Kopplungsanfrage des Browsers ist noch nicht verfügbar. Versuche es gleich erneut.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Der Thread hat den Branch gewechselt – überprüfen und erneut senden.",
    },
