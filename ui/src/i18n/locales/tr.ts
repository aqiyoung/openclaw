...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Gizli",
    incognitoDescription: "Bu konuşmayı yalnızca Gateway yeniden başlatılana kadar sakla",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Konuşma dal değiştirdi — gözden geçirip yeniden gönderin.",
    },
    waitingForApproval: "Onay bekleniyor…",
    startupStatus: {
    ...
    sessionSharing: {
      menu: "Konu dizisi paylaşımı",
      current: "Konu dizisi görünürlüğü: {visibility}",
