...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Gizli",
    incognitoDescription: "Bu ileti dizisini yalnızca Gateway yeniden başlatılana kadar tut",
  ...
  sessionsView: {
    ...
    approvalNeeded: "Onay gerekli",
    queuedMessage: "Gönderilmek üzere sıraya alınmış {count} mesaj",
    queuedMessages: "Gönderilmek üzere sıraya alınmış {count} mesaj",
  ...
  configForm: {
    showAdvanced: "Gelişmişi göster",
    advancedHidden: "{count} gelişmiş ayar gizli",
    advancedHiddenPlural: "{count} gelişmiş ayar gizli",
  ...
  modelSetup: {
    ...
    wizard: {
      ...
      title: "Bir sağlayıcıyla oturum açın",
      prepareTitle: "Bir yerel model kur",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Bu tarayıcı güncellemeden sonra bir kerelik cihaz onayına ihtiyaç duyuyor.",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Bu konu dizisinde yalnızca sahibi ve üyeler işlem yapabilir.",
    },
    sessionSuggestions: {
      suggest: "Öner",
