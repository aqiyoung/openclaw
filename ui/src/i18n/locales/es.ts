...
export const es: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Incógnito",
    incognitoDescription: "Mantener este hilo solo hasta que se reinicie el Gateway",
    startAsDraft: "Empezar como borrador",
  ...
  configView: {
    ...
    formUnsafeCount: "1 ajuste en esta configuración solo puede editarse como texto: {paths}",
    formUnsafeCountPlural:
      "{count} ajustes en esta configuración solo pueden editarse como texto: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Descarga un modelo compatible con herramientas desde tu servidor de Ollama",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner:
        "Este navegador aún necesita una aprobación única del dispositivo después de la actualización.",
  ...
  chat: {
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "Elimina los adjuntos antes de enviar una sugerencia de texto.",
