...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "シークレット",
    incognitoDescription: "このスレッドは Gateway が再起動するまでのみ保持されます",
  ...
  sessionsView: {
    ...
    approvalNeeded: "承認が必要",
    queuedMessage: "{count} 件のメッセージが送信待ち",
    queuedMessages: "{count} 件のメッセージが送信待ち",
  ...
  configForm: {
    showAdvanced: "詳細を表示",
    advancedHidden: "{count} 件の詳細設定を非表示",
    advancedHiddenPlural: "{count} 件の詳細設定を非表示",
    advancedDivider: "詳細",
    hideValue: "値を非表示",
    revealValue: "値を表示",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidth: "メッセージ幅",
      messageWidthHint:
        "中央揃えのトランスクリプトに使用する任意の CSS 幅です（例: 960px、82%、min(1280px, 82%)）。",
      messageWidthInvalid:
    ...
    formUnsafeCount: "この設定内の 1 件の項目はテキストとしてのみ編集できます: {paths}",
    formUnsafeCountPlural: "この設定内の {count} 件の項目はテキストとしてのみ編集できます: {paths}",
    formUnsafeMore: "+{count}件",
    openRawEditor: "Raw エディターを開く",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "このブラウザはアップデート後に一度だけデバイスの承認が必要です。",
      action: "このブラウザを保護",
      secureContextRequired:
        "このレガシーブラウザは一時的に利用可能です。HTTPS または localhost で開き直して、デバイス ID で保護してください。",
      pendingUnavailable:
  ...
  chat: {
    ...
    composer: {
      ...
      offlineQueuedHint: "オフライン — {count}件を保留中。接続が回復すると送信されます。",
