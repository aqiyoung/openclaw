...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Lebar CSS opsional untuk transkrip yang ditengahkan, seperti 960px, 82%, atau min(1280px, 82%).",
      messageWidthInvalid:
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable: "Permintaan pemasangan browser belum tersedia. Coba lagi sesaat lagi.",
