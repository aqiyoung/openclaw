...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "عرض CSS اختیاری برای متن گفتگوی وسط‌چین، مانند 960px، 82% یا min(1280px, 82%).",
      messageWidthInvalid:
    ...
    openRawEditor: "باز کردن ویرایشگر خام",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      intro: "دانلود یا آماده‌سازی یک مدل محلی روی این Gateway.",
      button: "راه‌اندازی / دانلود مدل",
      ollamaLabel: "Ollama",
      ollamaHint: "دانلود یک مدل با قابلیت ابزار از سرور Ollama شما",
      llamaCppLabel: "مدل محلی (llama.cpp)",
      llamaCppHint: "دانلود یک مدل محلی حدوداً ۵.۰ گیگابایتی؛ به ۱۶ گیگابایت RAM نیاز دارد",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس است. آن را از طریق HTTPS یا localhost دوباره باز کنید تا با هویت دستگاه ایمن شود.",
      pendingUnavailable: "درخواست جفت‌سازی مرورگر هنوز در دسترس نیست. لحظه‌ای دیگر دوباره تلاش کنید.",
      loadFailed: "بارگیری درخواست جفت‌سازی این مرورگر ممکن نشد: {error}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "رشته شاخه‌ها را تغییر داد — بررسی و دوباره ارسال کنید.",
    },
    waitingForApproval: "در انتظار تأیید…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      current: "قابلیت مشاهدهٔ رشته: {visibility}",
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "پیش از ثبت یک پیشنهاد متنی، پیوست‌ها را حذف کنید.",
