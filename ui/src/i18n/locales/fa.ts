...
export const fa: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "ناشناس",
    incognitoDescription: "این رشته گفتگو را فقط تا زمان راه‌اندازی مجدد Gateway نگه دارید",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "شاخه رشته گفتگو تغییر کرد — بررسی و دوباره ارسال کنید.",
    },
    waitingForApproval: "در انتظار تأیید…",
    startupStatus: {
    ...
    sessionSharing: {
      ...
      current: "قابلیت مشاهده رشته: {visibility}",
