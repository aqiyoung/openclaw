...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "시크릿",
    incognitoDescription: "Gateway가 다시 시작될 때까지만 이 스레드 유지",
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      menuLabel: "ID 메뉴",
      menuButtonLabel: "{name}님의 ID 및 앱 메뉴",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "스레드의 분기가 전환되었습니다 — 검토 후 다시 보내세요.",
    },
    waitingForApproval: "승인 대기 중…",
    startupStatus: {
