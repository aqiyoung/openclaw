...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "시크릿",
    incognitoDescription: "Gateway가 다시 시작될 때까지만 이 스레드를 유지합니다",
  ...
  sessionsView: {
    ...
    approvalNeeded: "승인 필요",
    queuedMessage: "보낼 메시지 {count}개 대기 중",
    queuedMessages: "보낼 메시지 {count}개 대기 중",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidth: "메시지 너비",
      messageWidthHint:
        "가운데 정렬된 대화 내용의 선택적 CSS 너비입니다. 예: 960px, 82%, min(1280px, 82%).",
      messageWidthInvalid:
    ...
    formUnsafeCount: "이 설정의 항목 1개는 텍스트로만 편집할 수 있습니다: {paths}",
    formUnsafeCountPlural: "이 설정의 항목 {count}개는 텍스트로만 편집할 수 있습니다: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppHint: "약 5.0GB 크기의 로컬 모델을 다운로드하세요. 16GB RAM이 필요합니다",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "업데이트 후 이 브라우저에는 일회성 기기 승인이 필요합니다.",
      action: "이 브라우저 보안 설정",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "스레드가 분기를 전환했습니다 — 검토 후 다시 보내세요.",
    },
    waitingForApproval: "승인 대기 중…",
    startupStatus: {
