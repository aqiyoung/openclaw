...
export const vi: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Chiều rộng CSS tùy chọn cho bản chép căn giữa, chẳng hạn như 960px, 82% hoặc min(1280px, 82%).",
      messageWidthInvalid:
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Tải mô hình có khả năng dùng công cụ từ máy chủ Ollama của bạn",
      llamaCppLabel: "Mô hình cục bộ (llama.cpp)",
      llamaCppHint: "Tải mô hình cục bộ khoảng 5.0 GB; yêu cầu 16 GB RAM",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Trình duyệt cũ này vẫn khả dụng tạm thời. Mở lại qua HTTPS hoặc localhost để bảo mật bằng danh tính thiết bị.",
      pendingUnavailable: "Yêu cầu ghép nối trình duyệt chưa khả dụng. Thử lại sau giây lát.",
  ...
  chat: {
    ...
    sessionSuggestions: {
      suggest: "Gợi ý",
      suggestMessage: "Gợi ý tin nhắn",
      attachmentsUnsupported: "Xóa tệp đính kèm trước khi gửi gợi ý văn bản.",
      sendNow: "Gửi gợi ý của {author} ngay",
      queue: "Xếp hàng gợi ý của {author}",
      edit: "Chỉnh sửa gợi ý của {author}",
      dismiss: "Bỏ qua gợi ý của {author}",
