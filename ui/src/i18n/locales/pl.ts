...
export const pl: TranslationMap = {
  ...
  configForm: {
    ...
    advancedHiddenPlural: "{count} ukrytych ustawień zaawansowanych",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Opcjonalna szerokość CSS dla wyśrodkowanego transkryptu, na przykład 960px, 82% lub min(1280px, 82%).",
      messageWidthInvalid:
        "Wprowadź szerokość CSS, taką jak 960px, 82%, min(1280px, 82%) lub calc(100% - 2rem).",
    },
    sidebarPrefs: {
      title: "Pasek boczny",
    ...
    formUnsafeCountPlural:
      "{count} ustawień w tej konfiguracji można edytować tylko jako tekst: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppHint: "Pobierz lokalny model o rozmiarze około 5,0 GB; wymaga 16 GB RAM",
    },
    manual: {
    ...
    wizard: {
      ...
      prepareStarting: "Uruchamianie konfiguracji modelu lokalnego…",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Wątek zmienił gałąź — sprawdź i wyślij ponownie.",
    },
    waitingForApproval: "Oczekiwanie na zatwierdzenie…",
    startupStatus: {
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported: "Usuń załączniki przed wysłaniem propozycji tekstowej.",
      sendNow: "Wyślij teraz propozycję od {author}",
      queue: "Dodaj propozycję od {author} do kolejki",
