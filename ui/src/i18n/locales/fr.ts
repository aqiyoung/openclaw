...
export const fr: TranslationMap = {
  ...
  configView: {
    ...
    formUnsafeCount:
      "1 paramètre de cette configuration ne peut être modifié qu'en tant que texte : {paths}",
    formUnsafeCountPlural:
      "{count} paramètres de cette configuration ne peuvent être modifiés qu'en tant que texte : {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      button: "Configurer / Télécharger un modèle",
      ollamaLabel: "Ollama",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Ce navigateur hérité reste disponible temporairement. Rouvrez-le en HTTPS ou localhost pour le sécuriser avec l'identité de l'appareil.",
      pendingUnavailable:
        "La demande d'association du navigateur n'est pas encore disponible. Réessayez dans un instant.",
      loadFailed: "Impossible de charger la demande d'association de ce navigateur : {error}",
  ...
  chat: {
    ...
    sessionSuggestions: {
      ...
      attachmentsUnsupported:
        "Supprimez les pièces jointes avant de soumettre une suggestion textuelle.",
