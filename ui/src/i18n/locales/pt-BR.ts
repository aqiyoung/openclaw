...
export const pt_BR: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner:
        "Este navegador ainda precisa de uma aprovação única do dispositivo após a atualização.",
      action: "Proteger este navegador",
      secureContextRequired:
        "Este navegador legado permanece disponível temporariamente. Reabra-o via HTTPS ou localhost para protegê-lo com a identidade do dispositivo.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Apenas o proprietário e os membros da conversa podem atuar nesta conversa.",
    },
    sessionSuggestions: {
      suggest: "Sugerir",
