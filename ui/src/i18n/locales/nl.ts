...
export const nl: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Incognito",
    incognitoDescription: "Bewaar dit gesprek alleen tot de Gateway opnieuw opstart",
  ...
  modelSetup: {
    ...
    wizard: {
      ...
      prepareStarting: "Lokaal model instellen wordt gestart…",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Deze browser heeft na de update nog eenmalig apparaatgoedkeuring nodig.",
      action: "Deze browser beveiligen",
      secureContextRequired:
        "Deze verouderde browser blijft tijdelijk beschikbaar. Heropen hem via HTTPS of localhost om hem met apparaatidentiteit te beveiligen.",
      pendingUnavailable:
        "Het koppelverzoek voor de browser is nog niet beschikbaar. Probeer het zo meteen opnieuw.",
      loadFailed: "Kan het koppelverzoek van deze browser niet laden: {error}",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Alleen de eigenaar en leden van de thread kunnen hierin acties uitvoeren.",
    },
    sessionSuggestions: {
      suggest: "Voorstellen",
